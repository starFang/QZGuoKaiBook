...
- (void)creatAnswerPressButton
{
    for (int i = 0; i < [self.qChoice.vChoices count]; i++)
    {
        ...
        [button setBackgroundImage:[UIImage imageNamed:@"1222.png"] forState:UIControlStateNormal];
        ...
        [button setImage:[UIImage imageNamed:@"n2.png"] forState:UIControlStateHighlighted];
        [button setImage:[UIImage imageNamed:@"n1.png"] forState:UIControlStateSelected];
...
- (void)clearAnswerButton
{
    for (int i = 0; i < [self.qChoice.vChoices count]; i++)
    {
        ...
        but.selected = NO;
        [but setBackgroundImage:[UIImage imageNamed:@"1222.png"] forState:UIControlStateNormal];
    }
    isVerifiedAnswer = NO;
