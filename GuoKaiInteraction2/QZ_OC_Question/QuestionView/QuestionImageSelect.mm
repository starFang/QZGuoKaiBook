...
- (void)creatAnswerPressButton
{
    for (int i = 0; i < [self.qImageSelect.vStrImage count]; i++)
    {
        ...
        UIImageView * imageView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"n1.png"]];
...
- (void)pressTwo:(UIButton *)button
{
    ...
    if ([self.qImageSelect.vAnswers count] == 1)
    {
        for (int i = 0 ; i < [self.qImageSelect.vStrImage count]; i++)
        {
            ...
            [imageView setImage:[UIImage imageNamed:@"n1.png"]];
        }
    ...
    for (int i = 0; i < [self.qImageSelect.vStrImage count]; i++)
        ...
        if (button.selected == YES)
        {
            ...
            [imageView setImage:[UIImage imageNamed:@"n2.png"]];
        }
